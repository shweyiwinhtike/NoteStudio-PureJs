...
/**
 * creates a navigation item representing a notebook. this item displays the notebook' name, allows editing,
...
`;
    ...
    // //show tootltip on edit and delete button
    const /**{Array <HTMLElement> } */ $tooltipElems = $navItem.querySelectorAll('[data-tooltip]');
    $tooltipElems.forEach($elem => tooltip($elem));


    /**handles the click event on the navigation item, Updates the note panel's title, retrieves the associates notes
