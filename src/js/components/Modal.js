 ...
 * @param {string} [title] - the default title got the note
 * @param {string} [text] - the default text for the note
 * @param {string} [time = ''] - the time associated with the note
 * @returns {Object} - and object containing functions to open the modal, close the modal and, handle note submissions.
 */
const NoteModal = function (title = '', text = '', time = '') {
    ...
    /**attach click event to close btn, when clicked, call the close modal function */
 ...
 * @returns {Object} - an object containing the functions to open the modal, close the modal, and handle confirmation
 */
