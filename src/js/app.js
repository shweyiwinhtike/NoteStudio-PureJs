...
/** 
 * initialize tooltip behavior for all DOM elements with a 'data-tooltip' attribue
*/

const /**{Array<HTMLELements} */ $tooltipElems = document.querySelectorAll('[data-tooltip]');
...
const /**{HTMLElements} */ $greetElem = document.querySelector('[data-greeting]');
...
/**shows a notebook creation field when the "add notebook" is clicked *
 * the function add a new netbook field element, make is editable and listen for the 'enter'
 * key button to create a new notebook when pressed**/
 ...
 * the new notebook will be stored in the database
 * 
...
const createNotebook = function (event) {
    ...
    if (event.key === "Enter") {
        ...
        // store new created notebook in the database
 ...
 * when a button is clicked, it will open a model for creating a new note and handles the submission of the new note to the database and client
 */
...
addEventOnElements($noteCreateBtns, 'click', function () {
    ...
    //handles the submission of the new note to the database and client
 ...
 * the active notebook's ID and uses the client to display the notes */
